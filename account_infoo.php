...
$query="select * from user where mobile_num='$user1'";
...
echo"
    ...
    <div class='lawda'>
<button type='button' class='btn btn-success' data-bs-toggle='modal' data-bs-target='#exampleModal'><a href='transactions.php' style='text-decoration:none;color:black;font-weight:bolder;' >Transactions</a> </button>
</div>
