...
<nav>
  ...
  <section class='wrapper'>
    <!-- Row title -->
    <main class='row title' style='padding-top: 0px;'>
      <ul>
        <li>User Name</li>
        <li>Phone no.</li>
        <li>Time</li>
...
echo"
    ...
    <section class='row-fadeIn-wrapper'>
      <article class='row fadeIn nfl'>
        ...
        <ul>
          <li><a href='#'>".$row["username"]." </a><span class='small'>sent you</span></li>
...
<!-- Copyright -->
<div class='text-center p-3  footer1'  style='background-color: rgba(0, 0, 0, 0.2);'>
  © 2022 Copyright:
