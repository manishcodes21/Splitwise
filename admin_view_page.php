...
#contact_us {
 ...
 <body>
   ...
   <div id='settle_up'>
   <div id='content2'>
     <h1 style='color:orange;'>View Data</h1>
     <p style='color:white;font-size:x-large;'>You can view all the users on Splitwise</p>
     <button type='button' class='btn btn-info' name='view'> <a href='userdata.php'
       style='text-decoration:none;color:black;'>View</a> </button>
   </div>
   <div id='pic2'>
