...
$query2="select group_pay.payer_userid,group_pay.amount,group_pay.borrower_num ,settle_up.amount,settle_up.phone from group_pay,settle_up where settle_up.phone=group_pay.payer_userid and settle_up.amount=group_pay.amount and group_pay.description = settle_up.why and group_pay.borrower_num= (select mobile_num from user where mobile_num='$user')" ;  
